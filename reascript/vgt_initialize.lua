...
-- Duplicated from vgt_common.lua's folder_last_child_index: this file
-- deliberately has no dofile dependency of its own (see vgt_common.lua's
-- header for why). The region ends on the child whose I_FOLDERDEPTH brings
-- the running depth back to zero
