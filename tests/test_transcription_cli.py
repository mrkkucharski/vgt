...
def test_mt3_profiles_are_listed_and_show_their_pinned_identity(tmp_path: Path, capsys) -> None:
    ...
    assert shown["detection"]["model_id"] == "guitar-pilot-replay12s-checkpoint-1290000"
...
def test_variant_add_guitar_mt3(tmp_path: Path, capsys) -> None:
    ...
    assert variant["resolved_settings"]["detection"]["model_id"] == "guitar-pilot-replay12s-checkpoint-1290000"
