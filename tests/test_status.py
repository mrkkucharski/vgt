...
def test_status_reports_analysis_corrections_artifacts_and_json(tmp_path: Path, capsys) -> None:
    ...
    assert "guitar   872 notes, MIDI 40-76, profile guitar-klapuri, transcribed 2026-07-19T10:05:00Z" in text
    ...
    assert transcription["targets"]["guitar"]["effective_profile"] == "guitar-klapuri"
